...
function setPicTitle(fMenuName){
	...
	if(fMenuName == "最新动态" ||fMenuName == "自治区动态" ||fMenuName == "地州市动态"){
		fMenuName = "工作动态";
	}
	...
	if(datas.length>0){
		...
		if(menu1){
			if(menu1=='MENU001'){
				...
				_name="群众路线专栏";
			}else if (menu1=='MENU111'){
				_name="自治区动态";
			}else if (menu1=='MENU112'){
				_name="地州市动态";
			}
			setPicTitle(_name);		
		}
		var childTable=document.getElementById('childMenu');
		if(fMenuCode=='MENU008' || fMenuCode=='MENU111' || fMenuCode=='MENU112' ||menu1=='MENU111' ||menu1=='MENU112'){
		var c1='"#0554a3"'; var c2='"#000000"';
		var childLi ="<li onclick="+'"'+"openListPage("+"'"+"MENU008"+"'"+");"+'"'+"target='_self'><span style='cursor:pointer;' onMouseMove='this.style.color="+c1+"'; onMouseOut='this.style.color="+c2+"'> >> 最新动态</span> </li>"+"<li onclick="+'"'+"openListPage("+"'"+"MENU111"+"'"+");"+'"'+"target='_self'><span style='cursor:pointer;' onMouseMove='this.style.color="+c1+"'; onMouseOut='this.style.color="+c2+"'> >> 自治区动态</span></li>"+"<li onclick="+'"'+"openListPage("+"'"+"MENU112"+"'"+");"+'"'+"target='_self'><span style='cursor:pointer;' onMouseMove='this.style.color="+c1+"'; onMouseOut='this.style.color="+c2+"'> >> 地州市动态</span></li>"; 
		...
		if(null!=table){
			...
			for(var j=0;j<_count;j++){
				...
				if(fMenuCode == 'MENU008'){
					_name="最新动态";
					} else if(fMenuCode=='MENU111'){
					_name="自治区动态";
					} else if(fMenuCode=='MENU112'){
					_name="地州市动态";
					}
				setPicTitle(_name);
				...
				var fID=news[j].getAttribute('fID');
				 var li = '<li><span class='+'"'+'pl43'+'"'+'>'+shortDate+'</span><a href="javaScript:void(0)" target="_self" title='+fNewsTitle+' onclick="clickTitle(\''+fID+'\')">'+shortTitle+'</a>';
				lis+=li;
		...
		<div class="nav">
			...
			<ul class="navList"> 
				<li><a href="#" onclick='orgJsp();' >机构职能</a></li><li>|</li>
					<li onclick="openListPage('MENU008');" target="_self"><span  class="navListSpan" id='oneg1' style="cursor:pointer" onMouseMove="setSpanStyle('oneg1');" onMouseOut="clearSpanStyle('oneg1');">工作动态</span></li><li>|</li>
					<li onclick="openListPage('MENU001');" target="_self"><span  class="navListSpan" id='oneg2' style="cursor:pointer" onMouseMove="setSpanStyle('oneg2');" onMouseOut="clearSpanStyle('oneg2');">保密宣传</span></li><li>|</li>
					<li onclick="openListPage('MENU002');" target="_self"><span  class="navListSpan" id='oneg3' style="cursor:pointer" onMouseMove="setSpanStyle('oneg3');" onMouseOut="clearSpanStyle('oneg3');">保密科技</span></li><li>|</li>
					<li onclick="openListPage('MENU003');" target="_self"><span  class="navListSpan" id='oneg4' style="cursor:pointer" onMouseMove="setSpanStyle('oneg4');" onMouseOut="clearSpanStyle('oneg4');">政策法规</span></li><li>|</li>
					<li onclick="openListPage('MENU004');" target="_self"><span  class="navListSpan" id='oneg5' style="cursor:pointer" onMouseMove="setSpanStyle('oneg5');" onMouseOut="clearSpanStyle('oneg5');">监督检查</span></li><li>|</li>
					<li onclick="openListPage('MENU005');" target="_self"><span  class="navListSpan" id='oneg6' style="cursor:pointer" onMouseMove="setSpanStyle('oneg6');" onMouseOut="clearSpanStyle('oneg6');">测评审批</span></li><li>|</li>
					<li onclick="openListPage('MENU006');" target="_self"><span  class="navListSpan" id='oneg7' style="cursor:pointer" onMouseMove="setSpanStyle('oneg7');" onMouseOut="clearSpanStyle('oneg7');">服务保障</span></li>
			</ul>
			<div class="clear"></div>
		</div>
	</div>
	...
	<div class="content">
	 ...
	 -->
		...
		<div class="pageList_content">
			<div class="location">
				<h2 class="locationTxt"><span class="yourLocation">您的位置 </span><span class="pl41"><a href="#" onclick="returnIndexJsp();">首页>></a></span><span class="pl40" id="picTitle"></span></h2>
			</div>
