		...
		for(var i=0;i<count;i++){
			...
			if(null!=table){
				...
				for(var j=0;j<_count;j++){
					...
					var shortDateTime = fCreateDate.substring(0,10);
					...
					if(menuCode=='MENU010'){
						...
						picDiv =  "<div class=" + '"'+ "pr" +'"' +"><div class=txtbg></div><span>"+shortTitle+"\</span><a href=" + '"' + "javaScript:void(0)" +'"' + "target=" + '"' +"_parent" + '"'+" onclick="+'"'+"clickTitle("+"'"+fID+"'"+")"+'"'+"><img alt="+'"'+shortTitle+'"' +" src=" + '"' + addressIP+ fIsTop + '"'+" width=245 height=240></a></div>"
					} else if (menuCode=='MENU008' || menuCode=='MENU111' || menuCode=='MENU112'){
						li = "<li onclick="+'"'+"clickTitle("+"'"+fID+"'"+");"+'"'+"target='_self'><a href="+'"'+"javaScript:void(0)"+'"'+" title="+"'"+fNewsTitle+"   "+shortDate+"'"+">"+shortTitle+"<span class='right'>"+shortDateTime+"</span></a></li>";
					} else {
						li = "<li onclick="+'"'+"clickTitle("+"'"+fID+"'"+");"+'"'+"target='_self'><a href="+'"'+"javaScript:void(0)"+'"'+" title="+"'"+fNewsTitle+"   "+shortDate+"'"+">"+shortTitle+"</a></li>";
					}
					//<span class='right'>"+shortDate+"</span>
					lis += li;
					if(picDiv){
						picDivs += picDiv;
					}
				...
				if(menuCode=='MENU008'){
					...
					lis += "<li class='panelLast'><a class='more' href='#' onclick=" + '"' +"openListPage('MENU112')"+'"'+">更多 > ></a></li>";
								...
								//				  <a class="more" onclick="openListPage(" href="#" MENU008?)?="">
				table.innerHTML = lis;
